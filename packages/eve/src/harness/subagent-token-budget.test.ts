...
import { extendSessionTokenBudget, setTurnUsageState } from "#harness/turn-tag-state.js";
...
describe("resolveRemainingSessionTokenLimits", () => {
  ...
  it("measures a delegated grant from the current parent budget window", () => {
    ...
    const continued = extendSessionTokenBudget(exhausted);
